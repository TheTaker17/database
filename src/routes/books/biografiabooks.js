...
const Ciencia_FiccionBook = require('../../models/Biografia');

// Ruta para crear un nuevo libro
router.get('/new', (req, res) => {
    res.render('books/new-books', { categoria: 'biografia' });
});
...
router.get('/', async (req, res) => {
    ...
    res.render('books/all-books', { libros, categoria: 'biografia' });
});

// Ruta para editar un libro
router.get('/edit/:id', async (req, res) => {
    const editb = await Ciencia_FiccionBook.findById(req.params.id).lean();
    res.render('books/edit', { editb , categoria:'biografia'});
});
