// routes/cienciaficcion.js

const express = require('express');
const router = express.Router();
const Ciencia_FiccionBook = require('../../models/CienciaFiccion');

// Ruta para crear un nuevo libro
router.get('/new', (req, res) => {
    res.render('books/new-books', { categoria: 'cienciaficcion' });
});
...
router.get('/', async (req, res) => {
    ...
    res.render('books/all-books', { libros, categoria: 'cienciaficcion' });
});

// Ruta para editar un libro
router.get('/edit/:id', async (req, res) => {
    const editb = await Ciencia_FiccionBook.findById(req.params.id).lean();
    res.render('books/edit', { editb , categoria:'cienciaficcion'});
});
