...
const Ciencia_FiccionBook = require('../../models/Romance');

// Ruta para crear un nuevo libro
router.get('/new', (req, res) => {
    res.render('books/new-books', { categoria: 'romance' });
});
...
router.get('/', async (req, res) => {
    ...
    res.render('books/all-books', { libros, categoria: 'romance' });
});

// Ruta para editar un libro
router.get('/edit/:id', async (req, res) => {
    const editb = await Ciencia_FiccionBook.findById(req.params.id).lean();
    res.render('books/edit', { editb , categoria:'romance'});
});
