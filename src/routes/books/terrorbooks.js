...
const Ciencia_FiccionBook = require('../../models/Terror');

// Ruta para crear un nuevo libro
router.get('/new', (req, res) => {
    res.render('books/new-books', { categoria: 'terror' });
});
